...
class TestUpliftRandomForest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.uplift_random_forest_parameters = {
            "n_estimators": 5,
            "max_features": 5,
            "max_depth": 5,
            "min_samples_leaf": 50,
    ...
    def test_analyze(self):
        for eval_func in ["ED", "KL", "Chi", "DDP", "IT", "CIT", "CTS"]:
            urf = UpliftRandomForest(self.uplift_random_forest_parameters, self.approach_params, eval_function=eval_func)
            dict_scores = urf.analyze(self.ds_helper)
