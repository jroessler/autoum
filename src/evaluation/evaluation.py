...
class UpliftEvaluation:
    ...
    @staticmethod
    def calculate_uplift(bin_treatment_responder: list, bin_number_treated_samples: list, bin_non_treatment_responder: list, bin_number_non_treated_samples: list, bin_list: list,
                         num_treated_samples):
        """
    ...
    @staticmethod
    def plot_qini_curve(df_metrics: pd.DataFrame, df_opt_uplift_bins: pd.DataFrame, bins: int = 10, plot_optimum: bool = False, absolute: bool = False,
                        title: str = 'Qini Curve', save_figure: bool = False, path: str = None, plot_grayscale: bool = False, plot_uqc: bool = False, show_title=False,
                        fontsize=14, qc: bool = False):
        """
